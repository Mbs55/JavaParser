...
| **Decision latency**                   | Higher and more variable due to runtime PIP calls        | Low, as data is available locally                                       | Medium — PDP stays lightweight, but request preparation may add latency    | Low                                           |
